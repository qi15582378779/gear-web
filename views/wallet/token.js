var splToken = (function (exports) {
  ...
  function stylizeWithColor$1(str, styleType) {
    ...
    if (style) {
      return '\u001b[' + inspect$3.colors[style][0] + 'm' + str + '\u001b[' + inspect$3.colors[style][1] + 'm';
    } else {
      return str;
    }
  }
  ...
  function getMessage$1(self) {
    return truncate$1(inspect$2(self.actual), 128) + ' ' + self.operator + ' ' + truncate$1(inspect$2(self.expected), 128);
  }
  ...
  function _deepEqual$1(actual, expected, strict, memos) {
    ...
    if (actual === expected) {
      ...
      return compare$1(new Uint8Array(actual.buffer), new Uint8Array(expected.buffer)) === 0;
  ...
  function objEquiv$1(a, b, strict, actualVisitedObjects) {
    ...
    if (isPrimitive$1(a) || isPrimitive$1(b)) return a === b;
    ...
    for (i = ka.length - 1; i >= 0; i--) {
      key = ka[i];
      if (!_deepEqual$1(a[key], b[key], strict, actualVisitedObjects)) return false;
    }
    return true;
  }
  ...
  (function (module) {
    (function (module, exports) {
      ...
      */
      ...
      var groupBases = [
        0, 0, 33554432, 43046721, 16777216, 48828125, 60466176, 40353607, 16777216, 43046721, 10000000, 19487171, 35831808, 62748517, 7529536, 11390625, 16777216, 24137569, 34012224, 47045881, 64000000, 4084101, 5153632, 6436343, 7962624, 9765625, 11881376, 14348907, 17210368, 20511149, 24300000,
  ...
  (function (module) {
    (function (nacl) {
      ...
      var K = [
        0x428a2f98, 0xd728ae22, 0x71374491, 0x23ef65cd, 0xb5c0fbcf, 0xec4d3b2f, 0xe9b5dba5, 0x8189dbbc, 0x3956c25b, 0xf348b538, 0x59f111f1, 0xb605d019, 0x923f82a4, 0xaf194f9b, 0xab1c5ed5, 0xda6d8118, 0xd807aa98, 0xa3030242, 0x12835b01, 0x45706fbe, 0x243185be, 0x4ee4b28c, 0x550c7dc3, 0xd5ffb4e2,
        0x72be5d74, 0xf27b896f, 0x80deb1fe, 0x3b1696b1, 0x9bdc06a7, 0x25c71235, 0xc19bf174, 0xcf692694, 0xe49b69c1, 0x9ef14ad2, 0xefbe4786, 0x384f25e3, 0x0fc19dc6, 0x8b8cd5b5, 0x240ca1cc, 0x77ac9c65, 0x2de92c6f, 0x592b0275, 0x4a7484aa, 0x6ea6e483, 0x5cb0a9dc, 0xbd41fbd4, 0x76f988da, 0x831153b5,
        0x983e5152, 0xee66dfab, 0xa831c66d, 0x2db43210, 0xb00327c8, 0x98fb213f, 0xbf597fc7, 0xbeef0ee4, 0xc6e00bf3, 0x3da88fc2, 0xd5a79147, 0x930aa725, 0x06ca6351, 0xe003826f, 0x14292967, 0x0a0e6e70, 0x27b70a85, 0x46d22ffc, 0x2e1b2138, 0x5c26c926, 0x4d2c6dfc, 0x5ac42aed, 0x53380d13, 0x9d95b3df,
        0x650a7354, 0x8baf63de, 0x766a0abb, 0x3c77b2a8, 0x81c2c92e, 0x47edaee6, 0x92722c85, 0x1482353b, 0xa2bfe8a1, 0x4cf10364, 0xa81a664b, 0xbc423001, 0xc24b8b70, 0xd0f89791, 0xc76c51a3, 0x0654be30, 0xd192e819, 0xd6ef5218, 0xd6990624, 0x5565a910, 0xf40e3585, 0x5771202a, 0x106aa070, 0x32bbd1b8,
        0x19a4c116, 0xb8d2d0c8, 0x1e376c08, 0x5141ab53, 0x2748774c, 0xdf8eeb99, 0x34b0bcb5, 0xe19b48a8, 0x391c0cb3, 0xc5c95a63, 0x4ed8aa4a, 0xe3418acb, 0x5b9cca4f, 0x7763e373, 0x682e6ff3, 0xd6b2b8a3, 0x748f82ee, 0x5defb2fc, 0x78a5636f, 0x43172f60, 0x84c87814, 0xa1f0ab72, 0x8cc70208, 0x1a6439ec,
        0x90befffa, 0x23631e28, 0xa4506ceb, 0xde82bde9, 0xbef9a3f7, 0xb2c67915, 0xc67178f2, 0xe372532b, 0xca273ece, 0xea26619c, 0xd186b8c7, 0x21c0c207, 0xeada7dd6, 0xcde0eb1e, 0xf57d4f7f, 0xee6ed178, 0x06f067aa, 0x72176fba, 0x0a637dc5, 0xa2c898a6, 0x113f9804, 0xbef90dae, 0x1b710b35, 0x131c471b,
  ...
  function nullable(struct) {
    return new Struct$1({ ...struct, validator: (value, ctx) => value === null || struct.validator(value, ctx), refiner: (value, ctx) => value === null || struct.refiner(value, ctx) });
  }
  /**
  ...
  function optional(struct) {
    return new Struct$1({ ...struct, validator: (value, ctx) => value === undefined || struct.validator(value, ctx), refiner: (value, ctx) => value === undefined || struct.refiner(value, ctx) });
  }
  /**
  ...
  var lib = (secp256k1) => {
    return {
      contextRandomize(seed) {
        assert$h(seed === null || seed instanceof Uint8Array, 'Expected seed to be an Uint8Array or null');
      ...
      ecdsaRecover(sig, recid, msg32, compressed = true, output) {
        isUint8Array('signature', sig, 64);
        assert$h(toTypeString(recid) === 'Number' && recid >= 0 && recid <= 3, 'Expected recovery id to be a Number within interval [0, 3]');
        isUint8Array('message', msg32, 32);
        isCompressed(compressed);
        output = getAssertedOutput(output, compressed ? 33 : 65);
  ...
  var _args = [['elliptic@6.5.4', '/home/tyera_solana_com/solana-program-library/token/js']];
  ...
  (function (module) {
    ...
    (function () {
      ...
      var SHIFT = [0, 8, 16, 24];
      var RC = [
        1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649, 0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0,
  ...
  class Loader {
    ...
    static async load(connection, payer, program, programId, data) {
      ...
      while (array.length > 0) {
        ...
        transactions.push(
          sendAndConfirmTransaction$1(connection, transaction, [payer, program], {
            commitment: 'confirmed'
          })
  ...
  const { publicKeyCreate, ecdsaSign } = elliptic;
  ...
  struct([
    ...
    publicKey$1('authorizedVoterPubkey'),
    publicKey$1('authorizedWithdrawerPubkey'),
    u8('commission'),
    nu64(), // votes.length
  ...
  class u64 extends BN$9 {
    ...
    toBuffer() {
      ...
      const zeroPad = bufer.Buffer.alloc(8);
      b.copy(zeroPad);
      return zeroPad;
    }
    /**
