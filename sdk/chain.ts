...
export class Chain {
    ...
    public async signTypedMessage(domain: TypedDataDomain, types: Record<string, Array<TypedDataField>>, values: Record<string, any>): Promise<string> {
        const signer = this.getSigner(0);
    ...
    async getEthLogs(filter: { address?: string | string[]; topics?: string[]; fromBlock: string | number; toBlock: string | number }) {
