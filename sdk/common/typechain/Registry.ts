...
interface RegistryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "create(address,string,string)": FunctionFragment;
    "currentTokenId()": FunctionFragment;
    "encryptURLs(uint256)": FunctionFragment;
...
export interface Registry extends Contract {
  ...
  encryptURLs(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
